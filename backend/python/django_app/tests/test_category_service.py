...
class TestProductCategoryService(unittest.TestCase):
    ...
    def test_create_new_category_success(self):
        ...
        # Check if strip() was called on title
    ...
    # Test remove_product_from_category
